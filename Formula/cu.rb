class Cu < Formula
  ...
  url "https://github.com/Arnavxy/cu/archive/refs/tags/v0.2.9.tar.gz"
  sha256 "507837b4da487f6be4872d765aabc294e617e8ae28a16a4cbcec88e542f23126"
  license "MIT"
  ...
  test do
    assert_equal "cu 0.2.9", shell_output("#{bin}/cu --version").strip
