class Cu < Formula
  ...
  url "https://github.com/Arnavxy/cu/archive/refs/tags/v0.2.7.tar.gz"
  sha256 "54e6b4db07c1a061d909176ab922af9596daff47b0fe7349a821aca2ce948374"
  license "MIT"
  ...
  test do
    assert_equal "cu 0.2.7", shell_output("#{bin}/cu --version").strip
