class Cu < Formula
  ...
  url "https://github.com/Arnavxy/cu/archive/refs/tags/v0.3.4.tar.gz"
  sha256 "3152cff3e2101e3ec6b37d7f48a7d261de706816875d9f027dcaa3d2ba93eb84"
  license "MIT"
  ...
  test do
    assert_equal "cu 0.3.4", shell_output("#{bin}/cu --version").strip
