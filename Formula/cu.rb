class Cu < Formula
  ...
  url "https://github.com/Arnavxy/cu/archive/refs/tags/v0.2.8.tar.gz"
  sha256 "cc731fd2b9b31b35ec9eedb3a618c92b34c60fa9d88050da95a9a4eb6eef346e"
  license "MIT"
  ...
  test do
    assert_equal "cu 0.2.8", shell_output("#{bin}/cu --version").strip
