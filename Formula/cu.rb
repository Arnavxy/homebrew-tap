class Cu < Formula
  ...
  url "https://github.com/Arnavxy/cu/archive/refs/tags/v0.3.9.tar.gz"
  sha256 "371d37fab3ebf5c64394fd86c46c7b4ba2547bc5974b64d6126c49c8273250f6"
  license "MIT"
  ...
  test do
    assert_equal "cu 0.3.9", shell_output("#{bin}/cu --version").strip
