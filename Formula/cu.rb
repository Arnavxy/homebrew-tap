class Cu < Formula
  ...
  url "https://github.com/Arnavxy/cu/archive/refs/tags/v0.3.2.tar.gz"
  sha256 "75dc6d387661467179b666a2b3147a02fc5746039a546717a17c1fb344bf8cb2"
  license "MIT"
  ...
  test do
    assert_equal "cu 0.3.2", shell_output("#{bin}/cu --version").strip
