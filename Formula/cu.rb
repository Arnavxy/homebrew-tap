class Cu < Formula
  ...
  url "https://github.com/Arnavxy/cu/archive/refs/tags/v0.2.4.tar.gz"
  sha256 "11b51d0e7a48e17583f2110467df4efedab831bcc7dd133a58aa4f0b7621d25d"
  license "MIT"
  ...
  test do
    assert_equal "cu 0.2.4", shell_output("#{bin}/cu --version").strip
