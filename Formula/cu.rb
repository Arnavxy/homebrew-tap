class Cu < Formula
  ...
  url "https://github.com/Arnavxy/cu/archive/refs/tags/v0.2.3.tar.gz"
  sha256 "fd937fca66693602098297c226551f74ccffbc0376d6ff3dbcb1a546a739ed3c"
  license "MIT"
  ...
  test do
    assert_equal "cu 0.2.3", shell_output("#{bin}/cu --version").strip
