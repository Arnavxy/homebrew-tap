class Cu < Formula
  ...
  url "https://github.com/Arnavxy/cu/archive/refs/tags/v0.3.7.tar.gz"
  sha256 "a7cf4822ade4ac7ffc7c069e5d78ad52d6f9f1e26033bbe547c83fe9fb155af4"
  license "MIT"
  ...
  test do
    assert_equal "cu 0.3.7", shell_output("#{bin}/cu --version").strip
